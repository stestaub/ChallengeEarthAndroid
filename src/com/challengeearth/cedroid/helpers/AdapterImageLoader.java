...
/**
 * Legacy version for pre API 9 devices. Provides multithreaded asynchronous
 * image loading for AdapterViews, optimized. Pass in only one LoadPair or
 * List<LoadPair> per row!
 * 
